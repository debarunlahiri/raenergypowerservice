...
render_site_start($company, $navItems, 'career', 'Career | ' . $company['name'], 'Career opportunities for associates, senior engineers and draftman roles at RA Energy Power Service.');
...
<section class="section career-section">
    <div class="wrap career-layout">
        <div class="career-intro reveal">
            ...
            <p class="lead">RA Energy Power Service is accepting career profiles for experienced site and technical professionals.</p>
        </div>
